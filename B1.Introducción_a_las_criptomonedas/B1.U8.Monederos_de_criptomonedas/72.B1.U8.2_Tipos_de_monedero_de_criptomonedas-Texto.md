...
1. Al no mantenerse en línea con las redes blockchain e Internet, ofrecen **protección** y seguridad **c****ontra los malwares y otros softwares maliciosos.**
...
3. **Las claves privadas son generadas de forma aleatoria y sin patrones a través de un _R_**_**andom Number Generator (RNG).**_
